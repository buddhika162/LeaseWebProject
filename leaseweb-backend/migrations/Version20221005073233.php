...
final class Version20221005073233 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE server_ram_module (id INT AUTO_INCREMENT NOT NULL, server_id INT NOT NULL, ram_id INT NOT NULL, INDEX IDX_AB74932CDFC5FC5E (server_id), INDEX IDX_AB74932C8AC2A195 (ram_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
